...
**Frameworks and Libraries:** React, Expo Go, Flutter, CodeIgniter 4, SDL3, SDL3_ttf, SDL3_image
...
### [Learning-API-PHP](https://github.com/LucasLixo/Learning-API-PHP)
Pure PHP study — simple REST API with endpoints reading data from a local `.csv` file.
